...
__all__ = ["PATH_CHROMEDRIVER", "logger", "PROJECT_DATABASE"]
# ---------------------------------------------------
# TODO [√] 项目索引路径定位
# ---------------------------------------------------
...
# ---------------------------------------------------
# 运行日志路径
PATH_LOGGER = join(PROJECT_DATABASE, "logs")
# 运行日志
logger.add(
    sink=join(PATH_LOGGER, "error.log"),
    level="ERROR",
    rotation="1 week",
    encoding="utf8",
)
...
logger.add(
    sink=join(PATH_LOGGER, "runtime.log"),
    level="DEBUG",
    rotation="1 day",
    retention="20 days",
    encoding="utf8",
...
# 目录补全
for _pending in [PROJECT_DATABASE, ]:
